...
gulp.task('watch-less', function() {
    gulp.watch(main_folder + lessFiles, ['less']);
})
gulp.task('watch-ts', function() {
    gulp.watch(main_folder + tsFiles, ['compile-typescript']);
})
gulp.task('watch-css-new-files', function() {
    gulp.watch(main_folder + cssDest + '/*.css', ['index-inject']);
})
gulp.task('watch-new-js-files',function(){
    gulp.watch(main_folder + jsFiles, ['js-compress']);
})
gulp.task('watch-new-min-js-files',function(){
    gulp.watch(main_folder + jsDest + '/*.js', ['index-inject']);
})
